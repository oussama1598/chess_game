...
const std::string Errors::INVALID_DESTINATION_POSITION{"Invalid destination position!"};
const std::string Errors::INVALID_SOURCE_POSITION{"Invalid source position"};
